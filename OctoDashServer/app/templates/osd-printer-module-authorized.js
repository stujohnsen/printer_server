...
var offlineImageSrc = "{{ url_for('static', filename='img/offline.png') }}";
...
printerModule.prototype.createPrinterModule = function(printer) {
    ...
    printerIcon.src = "{{ url_for('static', filename='img/3dprinter_icon.png') }}";

    var infoIcon = document.createElement("IMG");
    infoIcon.className = "icon info_icon";
    infoIcon.id = "info_icon" + Number(module.id);
    infoIcon.src = "{{ url_for('static', filename='img/info_icon.png') }}";
    ...
    settingsIcon.src = "{{ url_for('static', filename='img/gear_icon.png') }}";
...
printerModule.prototype.createSettingsOverlay = function(id) {
    ...
    rotateLeftIcon.src = "{{ url_for('static', filename='img/rotate_left.png') }}";
    ...
    rotateRightIcon.src = "{{ url_for('static', filename='img/rotate_right.png') }}";
